  ...
  <html lang="en">
    <head>
      ...
      <link rel="stylesheet" href="styles/main.css">
        <link rel="stylesheet" href="styles/my-movies.css">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">   
          ...
          <div class="my-movies-container" style="display:block;">
                ...
                <div class="movie-item"  id="the-patriot" style="display:block">
                        ...
                        <!-- dynamically removes element from screen -- DOM manipulation -->
                        <a class="btn btn-danger" onclick="removeMovie(this)" href="#" style="float:right;margin-right:5%;">
                                <i class="fa fa-minus-square fa-lg"id="minus-button"></i></a>
                        
                      </div>
          </div>
          
            <div class="movie-recommendations-container" style="display:block;clear:both; margin-top:10%">
                    <hr>
              ...
              <div class="movie-item" id="the-godfather" style="display:block; clear:both;">
                  ...
                  <!-- dynamically adds element to screen -- DOM manipulation -->
                  <a class="btn btn-success" href="#" onclick="addMovie(this)" style="float:right;margin-right:2%">
            ...
            <div class="movie-item" id="edward-scissorhands" style="display:block; clear:both;">
                  ...
                  <!-- dynamically removes element from screen -- DOM manipulation -->
                  <a class="btn btn-danger" href="#" onclick="removeMovie(this)" style="float:right;margin-right:5%;">
                        <i class="fa fa-minus-square fa-lg"id="minus-button"></i></a>
                <!-- dynamically adds element to screen -- DOM manipulation -->
                <a class="btn btn-success" href="#" onclick="addMovie(this)" style="float:right;margin-right:2%">
                    <i class="fa fa-plus-square fa-lg" id="plus-button"></i></a>
          ...
          <script>
            ...
            // dynamically adds movie to the my movies list from the recommended movies list
              function addMovie(row){
