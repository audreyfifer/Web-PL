     ...
     <nav class="navbar navbar-expand-md bg-custom-header navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">   
          ...
          <div class="movie-results-container" style="display:block">
              <h1 id="search-title" style="margin-left:10px;margin-top:10px;">Edward Scissorhands (1990)</h1>  
              <div class="movie-item" style="display:block">
                <img src = "../images/edward-scissorhands.jpg" id="movie-result" alt="image showing logo" class="img-responsive" style="float:left">
