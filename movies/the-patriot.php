     ...
     <nav class="navbar navbar-expand-md bg-custom-header navbar-dark">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="collapsibleNavbar">   
          ...
          <div class="movie-results-container" style="display:block">
              <h1 id="search-title" style="margin-left:10px;margin-top:10px;">The Patriot (2000)</h1>  
              <div class="movie-item" style="display:block">
                <img src = "../images/the-patriot.jpg" id="movie-result" alt="image showing logo" class="img-responsive" style="float:left">
                <span id="movie-info" style="float:left">
                  <div >
                      <a>Synopsis: Peaceful farmer Benjamin Martin is driven to lead the Colonial Militia<br/> during the American Revolution when a sadistic British officer murders his son.</a><br/>
